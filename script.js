...
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzOU9_jfBR6ZO2-8o_FkmFKTIo_sqVkFpSTtZh-8gC9FBXoME_T0honPyFOn40orc6Thw/exec';
...
const STUDIO_ONLY_TABLES = [
  ...
  desc: "매해 돌아오는 하루, 가장 사랑스럽게 기억될 오늘.<br>왕관 및 의상, 양말이 스튜디오에 준비되어 있으며<br>거치대 설치형 풍선으로 세팅됩니다.<br>유료 추가 옵션을 통해 헬륨 풍선 연출로 변경 가능합니다.<br><br>※ 이미지 속 인형은 연출용으로, 실제 구성은 테디모먼트의 곰인형으로 준비됩니다.<br>아이가 평소 좋아하는 인형이나 장난감을 가져오셔서 곰인형 자리에 바꿔 셋팅하시면, <br>우리 아이만의 더욱 자연스럽고 특별한 생일 분위기를 완성하실 수 있습니다.",
